...
// cli/lib/archive.mjs (phase 7) in v0.8 to bring this file under the
// 1500-line threshold per the v0.8 ROADMAP item. Functions are imported
// at the top of this file and re-exported here so existing test imports
// (`import { runPhase4Stamp } from '../reindex.mjs'`) keep working.
export { runPhase4Stamp, runPhase5Swap, runPhase6Verify, runPhase7Report };
