...
- **Read-filter regression tests** — `test/read-filter-superseded.test.mjs` pins default-exclude / `include_superseded` / absence-tolerance behavior; no existing recall test changed expectations (D3.1 is purely additive).
