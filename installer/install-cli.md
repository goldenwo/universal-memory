...
$HOME/.local/share/um/
  cli/
    ...
    um-alert.sh           # pipeline alarm (cron-friendly; five sections:
                          # capture freshness, LEDGER reaction errors, per-layer
                          # staleness, #267 client-reported capture anomalies,
                          # and #283 crash-dead — armed surfaces gone turn-dead)
