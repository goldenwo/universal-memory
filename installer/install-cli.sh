...
COPIED_SCRIPTS=0
for script in um um-capture um-search.sh um-state.sh um-recent.sh um-list.sh um-capture.sh um-tail.sh um-forget um-supersede um-preview um-tunnel um-alert.sh um-drain.sh; do
